...
export const WebPixelEventsSettingsSchema = z.object({
  ...
  cart_viewed: z.boolean().describe(`event logs an instance where a customer visited the cart page.`).default(true),

  product_removed_from_cart: z
    .boolean()
    .describe(
  ...
  checkout_contact_info_submitted: z
    .boolean()
    .describe(
  ...
  checkout_address_info_submitted: z
    .boolean()
    .describe(
  ...
  checkout_shipping_info_submitted: z
    .boolean()
    .describe(
  ...
  clicked: z.boolean().describe(`event logs an instance where a customer clicks on a page element.`).default(false),
  form_submitted: z.boolean().describe(`event logs an instance where a form on a page is submitted.`).default(false),
